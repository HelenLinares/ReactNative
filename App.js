...
const obtenerPaises = async () => {
  try {
    const response = await fetch(
      "https://restcountries.com/v3.1/all?fields=name,capital,currencies,region,cca3,languages,flag"
    );
    ...
    <View style={{ flex: 1 }}>
      <View style={styles.navbar}>
        <TouchableOpacity onPress={() => setPantalla("todos")}>
          <Text style={[styles.navItem, pantalla === "todos" && styles.activo]}>Todos</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => setPantalla("america")}>
          <Text style={[styles.navItem, pantalla === "america" && styles.activo]}>América</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => setPantalla("europa")}>
          <Text style={[styles.navItem, pantalla === "europa" && styles.activo]}>Europa</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => setPantalla("asia")}>
          <Text style={[styles.navItem, pantalla === "asia" && styles.activo]}>Asia</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => setPantalla("oceania")}>
          <Text style={[styles.navItem, pantalla === "oceania" && styles.activo]}>Oceanía</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => setPantalla("idioma")}>
          <Text style={[styles.navItem, pantalla === "idioma" && styles.activo]}>Idioma</Text>
        </TouchableOpacity>
      </View>
